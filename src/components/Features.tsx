  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <SectionHeading
          eyebrow="Por qué ARQSTUDIO"
          title="Cómo trabajamos, y qué nos hace diferentes"
          lead="No es un despacho grande con filas y recepcionistas. Es el arquitecto atendiendo su proyecto directamente, con las mismas herramientas y más claridad."
        />
