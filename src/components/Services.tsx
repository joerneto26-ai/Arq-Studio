  ...
  return (
    <div className="relative flex h-full flex-col rounded-3xl border border-bone-200/80 bg-white/60 p-8 text-ink-900 transition-all duration-300 hover:border-sand-500/30 hover:shadow-card">
      ...
      <div className="mt-auto pt-8">
        <Button
          href={waLink(
            `Hola ARQSTUDIO, me interesa el plan "${s.name}". ¿Me pueden dar más información y una cotización?`
          )}
          target="_blank"
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <Reveal delay={0.1}>
          <p className="mx-auto mt-10 max-w-2xl text-center text-xs leading-relaxed text-stone-500">
            Los montos se confirman tras una primera conversación y la
            cotización final siempre se entrega por escrito, sin compromiso.
          </p>
        </Reveal>
      </div>
    </section>
