        ...
        <div>
          ...
          <Reveal delay={0.08}>
            <h2 className="mt-5 font-display text-[1.9rem] leading-[1.1] tracking-tight text-ink-900 sm:text-4xl lg:text-[2.6rem]">
              Una inversión en su calidad de vida, no un gasto.
            </h2>
          </Reveal>
          <Reveal delay={0.16}>
            <p className="mt-5 max-w-xl text-base leading-relaxed text-stone-600 sm:text-lg">
              Cada metro cuadrado que diseñamos está pensado para elevar su
              día a día y el valor de su propiedad a largo plazo.
            </p>
          </Reveal>
          <Reveal delay={0.24}>
          ...
          <Reveal delay={0.3}>
            <div className="mt-9">
              <Button
                href={waLink(
                  "Hola ARQSTUDIO, me gustaría saber cómo trabajan y qué incluye su servicio."
                )}
                target="_blank"
