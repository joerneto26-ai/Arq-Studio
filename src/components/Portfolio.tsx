...
const CATEGORIES = ["Todos", "Residencial", "Comercial"] as const;
          ...
          title={
            <>
              ...
              <span className="font-medium italic text-gradient-brass accent-underline">
                definen nuestro sello
              </span>
            </>
          }
          lead="Proyectos reales en Mazatlán, con su alcance exacto. Filtre por tipo para ver espacios similares al suyo."
        />
            ...
            {visible.map((p, i) => {
              ...
              return (
                <a
                  key={p.title}
                  href={waLink(
                    `Hola ARQSTUDIO, vi el proyecto "${p.title}" en su portafolio y me gustaría algo similar. ¿Me pueden cotizar?`
                  )}
                  target="_blank"
