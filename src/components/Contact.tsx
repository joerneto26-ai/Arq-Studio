...
const MAPS_EMBED =
  "https://www.google.com/maps?q=ArqStudio+Sector+L+82140+Mazatlan+Sin&t=&z=15&ie=UTF8&iwloc=&output=embed";

const MAPS_LINK =
  "https://www.google.com/maps/search/?api=1&query=ArqStudio+Sector+L+82140+Mazatlan+Sin";
...
export function Contact() {
  ...
  function onSubmit(e: FormEvent) {
    ...
    const msg =
      `Hola ARQSTUDIO, soy ${form.nombre} (${form.email}).\n` +
    ...
    <section id="contacto" className="bg-bone-50 py-20 sm:py-28 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <SectionHeading
          ...
          lead="Complete el formulario y le respondemos por WhatsApp el mismo día hábil con una propuesta sin compromiso."
        />
          ...
          <Reveal>
            ...
            >
              <ul className="mb-7 space-y-2.5 border-b border-bone-200/80 pb-6">
                {[
                  "Propuesta con alcance y costo por escrito",
                  "Tres modalidades de precio a elegir",
                  "Renders 3D antes de invertir",
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Cuéntenos qué imagina o qué necesita..."
                    className={`${inputCls} resize-none`}
                  />
                  <p className="mt-1.5 text-xs text-stone-500">
                    Opcional · Cuéntenos qué imagina o qué necesita
                  </p>
                </div>
              </div>
          ...
          <Reveal delay={0.12}>
            <div>
              <div className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-bone-200/80 shadow-soft">
                <iframe
                  src={MAPS_EMBED}
                  title="Ubicación de ARQSTUDIO en Google Maps"
                  loading="lazy"
        ...
        <div className="text-center">
          <SectionHeading
            ...
            lead="Si su proyecto está en Mazatlán o alrededores, podemos ayudarle."
          />
          ...
          <Reveal delay={0.16}>
            <p className="mt-6 text-sm text-stone-600">
              ¿No ve su zona?{" "}
              <a
                href={waLink("Hola ARQSTUDIO, quiero saber si atienden en mi zona.")}
                target="_blank"
                rel="noopener noreferrer"
